...
namespace JsonModels.Character
{
    public class Character
    {
        ...
        // [JsonConverter(typeof(PrioritySkillsConverter))]
        // public PrioritySkills? Priorityskills { get; set; }
        ...
        public Limitmodifiers? Limitmodifiersphys { get; set; }

        [JsonPropertyName("limitmodifiersment")]
        public Limitmodifiers? Limitmodifiersment { get; set; }

        [JsonPropertyName("limitmodifierssoc")]
        public Limitmodifiers? Limitmodifierssoc { get; set; }
